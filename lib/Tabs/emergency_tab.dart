...
import 'package:post_found/requests.dart';
...
class _EmergencyTabState extends State<EmergencyTab> {
  ...
  Future<void> loadPosts({bool refresh = true}) async {
    String postEmergencyRaw = json.encode(await API.getPostEmergency( refresh: refresh));
    ...
    return Card(
      ...
      child: Column(
        ...
        children: [
          ListTile(
            title: Text(
              'Blood type $bloodGroup requested by $username',
